...
class _NotificationsScreenState extends State<NotificationsScreen> {
                ...
                children: [
                  ...
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      icon: const Icon(Icons.visibility_outlined, size: 14, color: AppColors.goldMid),
                      label: const Text('Detail', style: TextStyle(fontSize: 12, color: AppColors.goldMid)),
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _detailInfoCard(Icons.description_outlined, 'Deskripsi',
                      ...
                      _detailInfoCard(Icons.account_balance_wallet_outlined, 'Anggaran',
                          currencyFormat.format(activity.budget), valueColor: AppColors.goldMid),
                      _detailInfoCard(Icons.location_on_outlined, 'Lokasi', activity.location),
                      if (activity.latitude != null && activity.longitude != null)
                        _detailInfoCard(Icons.map_outlined, 'Koordinat',
                      ...
                      Container(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Dibuat: ${DateFormat('dd MMM yyyy, HH:mm').format(activity.createdAt)}',
  ...
  Widget _detailInfoCard(IconData icon, String label, String value, {Color? valueColor}) {
    return Container(
      margin: const EdgeInsets.only(bottom: 10),
      padding: const EdgeInsets.all(14),
      decoration: BoxDecoration(
